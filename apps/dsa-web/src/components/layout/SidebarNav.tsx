...
import { Activity, BarChart3, Bell, BriefcaseBusiness, Gauge, Home, Landmark, LogOut, MessageSquareQuote, Search, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'institutional-holdings', labelKey: 'layout.nav.institutionalHoldings', to: '/institutional-holdings', icon: Landmark },
